...
class MatrixTest extends TestCase
{
    ...
    {
        $matrix = new Matrix($this->createDictionaryDirectory(3, 2, [10, 20, 30, -5, -6, -7]));
    ...
    {
        $matrix = new Matrix($this->createDictionaryDirectory(2, 3, [1, 2, 3, 4, 5, 6, 999]));
